...
Return value is an object made available to [`onProcessCpu`](/docs/api/engine/camerapipelinemodule/onprocesscpu) and
[`onUpdate`](/docs/api/engine/camerapipelinemodule/onupdate) as:
