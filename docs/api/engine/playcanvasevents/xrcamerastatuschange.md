...
[`onCameraStatusChange`](/docs/api/engine/camerapipelinemodule/oncamerastatuschange) from
[`XR8.addCameraPipelineModule()`](/docs/api/engine/camerapipelinemodule) for more information on the possible status.
