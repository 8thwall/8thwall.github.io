...
This event is emitted by [`xrface`](/docs/api/engine/aframe/xrface) when a tracked face's distance in millimeters between the centers of each pupil is first detected.
