...
[`screenshotready`](/docs/api/engine/aframeevents/screenshotready) event with the JPEG compressed image or
[`screenshoterror`](/docs/api/engine/aframeevents/screenshoterror) if an error has occured.
