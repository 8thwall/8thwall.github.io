...
:::info
To integrate 8th Wall into projects that are **not developed with Studio**, see [documentation on 8th Wall Engine](/docs/engine).
:::
...
- Select your platform:
  ...
  - **Intel**
  - **Windows**
- Install the application by opening the `.dmg` or `.exe` file and dragging the app to your Applications folder.
...
![StudioSettings](/images/getting-started/studio-settings.png)
