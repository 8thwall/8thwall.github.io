...
If this is your first time opening Studio, see the documentation on [navigating the interface](/docs/getting-started/navigate-interface/).

## Adding Entities

Add new objects to your space by clicking the **+** button above the scene hierarchy.

![](/images/getting-started/adding-entities.png)
...
![](/images/getting-started/transform.png)
...
![](/images/getting-started/inspector.png)
