...
:::warning[Important]
Be sure to make [required project updates](/docs/migration/project-updates.md) and review updated documentation on [publishing your project](/docs/getting-started/publishing).
:::
