...
If this is your first time opening Studio, see the documentation on [navigating the interface](/studio/getting-started/navigate-interface/).

## Adding Entities

Add new objects to your space by clicking the **+** button above the scene hierarchy.

![](/images/studio/getting-started/adding-entities.png)
...
![](/images/studio/getting-started/transform.png)
...
![](/images/studio/getting-started/inspector.png)
