...
{frontMatter.description} When you define a schema, you'll provide an object containing key/value pairs where the key is the name of the property, and the value is an [ECS type](/studio/api/ecs/#types) that specifies the kind of data that property will hold.
