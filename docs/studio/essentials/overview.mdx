...
A World is the container for all spaces/entities, and exposes APIs for [audio](/studio/api/world/audio), [events](/studio/api/world/events/), [3D transforms](/studio/api/world/transform/), and more.
