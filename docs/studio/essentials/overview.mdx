...
A World is the container for all spaces/entities, and exposes APIs for [audio](/docs/api/studio/world/audio), [events](/docs/api/studio/world/events/), [3D transforms](/docs/api/studio/world/transform/), and more.
