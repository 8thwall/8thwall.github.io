...
## Introduction
{frontMatter.description} By default, all video textures and UI videos default to **muted autoplay**. To customize video behavior, use [`VideoControls`](/studio/api/ecs/video-controls).
